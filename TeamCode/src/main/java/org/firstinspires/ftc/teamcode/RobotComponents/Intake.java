...
public class Intake {
    ...
    public static double intakeSlowSpeed = .7, intakeFastSpeed = .8, intakeReversedSpeed = -.7;

    public static double intakeStopperDownPosition = 1.0, intakeStopperOutPosition = 0.0;
